...
def main():
    ...
    results_path = RESULTS_DIR / "bert_grid.csv"
    ...
    for lr, batch_size, weight_decay, freeze_bert, epochs in itertools.product(
        GRID["learning_rate"],
        GRID["batch_size"],
        GRID["weight_decay"],
        GRID["freeze_bert"],
        ...
        print("\n" + "=" * 20)
        print(f"Running config: lr={lr}, batch_size={batch_size}, weight_decay={weight_decay}, freeze_bert={freeze_bert}, epochs={epochs}")
        print("=" * 20)
        ...
        if val_macro_f1 > best_macro_f1:
            ...
            best_config = (lr, batch_size, weight_decay, freeze_bert, epochs)
    ...
    print(f"Best config: lr={best_config[0]}, batch_size={best_config[1]}, weight_decay={best_config[2]}, freeze_bert={best_config[3]}, epochs={best_config[4]}")
